...
# from app.models.api_models import NotificationCategory, NotificationChannel, NotificationStatus, UserRole
...
# def create_template(request: NotificationTemplateCreate, db: Session = Depends(get_db)):
...
# def list_templates(category: Optional[NotificationCategory] = None, db: Session = Depends(get_db)):
