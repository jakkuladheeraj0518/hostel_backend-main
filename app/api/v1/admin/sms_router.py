...
def create_template(
    ...
    _: None = Depends(permission_required(Permission.MANAGE_SMS)),
):
...
def list_templates(
    ...
    _: None = Depends(permission_required(Permission.READ_SMS)),
):
...
async def send_otp(
    ...
    msg = f"Your OTP is {code}. Valid for {request.validity_minutes} minutes."
